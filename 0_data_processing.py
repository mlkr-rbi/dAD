...
c_space = pd.read_csv('./sckba/c_space.csv', index_col='Unnamed: 0')
t_space = pd.read_csv('./sckba/t_space.csv', index_col='Unnamed: 0')
...
i_space.to_csv('./sckba/i_space.csv', index=False)
...
for s in SX:
    ...
    # UPLOAD DATA
    test_x = pd.read_csv('./sckba/test_' + s + '.csv')
