...
i_space =  pd.read_csv('./scenarios/i_space.csv', index_col='Unnamed: 0')
model = pickle.load(open('./scenarios/xgb_reg.pkl','rb'))


for s in sx:

    # Load data and model
    data_ts =  pd.read_csv('./scenarios/test' + s + '_test.csv', index_col='Unnamed: 0')
    ts_C =  pd.read_csv('./scenarios/' + s + '_C.csv', index_col='Unnamed: 0')
    ts_T =  pd.read_csv('./scenarios/' + s + '_T.csv', index_col='Unnamed: 0')
